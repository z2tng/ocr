...
private:
    std::vector<base::TextBox> FindRsBoxes(const cv::Mat &feat, const cv::Mat &binary_feat, base::ScaleParam &scale_param, float box_score_threshold, float box_threshold, float unclip_ratio);
